...
paketinstall () {
	...
	echo -e "     \033[47;1;37m└\033[22;30m────────────────────────────────────────────────────────┘\033[44m"
	echo -e "\n\c"
	yast -i apache2 apache2-mod_perl apache2-mod_php5 apache2-mod_python automake bison cairo cairo-devel dialog dejavu dos2unix flex fltk fping freetype gcc gcc-c++ gd gd-devel giflib glibc gmp-devel gnuplot gnutls gnutls-devel gtk2 gtk2-devel joe kernel-source libmcrypt libmcrypt-devel libmysqlclient-devel libpcap libpng-devel mailx mc mysql mysql-devel net-snmp net-snmp-devel nmap openldap2-client openldap2-devel openssl-devel perl-Algorithm-Diff perl-DBD-mysql perl-Net-DNS perl-Net-Daemon perl-Net-IP perl-Net-SNMP perl-Net-Server perl-Net-Telnet perl-SNMP perl-XML-LibXML perl-XML-RegExp php5 php5-devel php5-dom php5-gd php5-gettext php5-iconv php5-ldap php5-mbstring php5-mcrypt php5-mysql php5-pear php5-pear-log php5-snmp php5-sockets php5-xsl php5-xmlreader php5-xmlrpc php5-zlib sysstat xorg-x11-font zlib 
	if [ $? != 0 ]; then
